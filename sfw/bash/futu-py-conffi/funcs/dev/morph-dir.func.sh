...
# 's#sfw#docs#g;print'|perl -ne 's#bash#txt#g;print'|perl -ne 's#help.sh#help.txt#g;print') ; done <
# <(find sfw/bash/futu-py-conffi/funcs/ -type f)
#------------------------------------------------------------------------------
doMorphDir(){
...
#eof file: sfw/bash/futu-py-conffi/funcs/dev/morph-dir.func.sh
